...
Processed data used to generate the figures are provided in the folder 'data/processed'
...
- GLAMOS database ([https://www.glamos.ch](https://www.glamos.ch)); 
...
- GLACIOCLIM database ([https://glacioclim.osug.fr](https://glacioclim.osug.fr));
